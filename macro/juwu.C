...
void juwu(std::string inputFile, std::string outputFile){
  ...
  TH1F* h_genZRap = new TH1F("h_genZRap","",40,-5,5);
  ...
  TH1F* h_genJetRap = new TH1F("h_genJetRap","",40,-5,5);
  ...
  for(long jEntry=0; jEntry<data.GetEntriesFast() ;jEntry++){
    ...
    //cout<<"========== beginning of entries =========="<<endl;
	...
	countjet++;	
	 ...
	 h_genJetRap->Fill(jet_l4.Rapidity(),weight);
